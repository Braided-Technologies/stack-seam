...
export default function SearchToolDialog({ open, onOpenChange }: SearchToolDialogProps) {
  ...
  const guessCategory = (text: string): string => {
    ...
    const keywords: [string[], string][] = [
      ...
      [['asset management', 'asset tracking', 'hardware lifecycle', 'warranty lookup', 'cmdb'], 'Asset Management'],
      [['vcio', 'qbr', 'strategy', 'technology business review'], 'vCIO / Lifecycle Management'],
